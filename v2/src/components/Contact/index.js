      ...
      <div className="relative max-w-7xl mx-auto lg:grid lg:grid-cols-5">
            ...
            <dl className="mt-8 text-base text-gray-500">
              ...
              <div className="mt-6">
                ...
                <dd className="flex">
                  ...
                  <span className="ml-3">
                    ...
                    <a href="tel:+1 559 206 3928">+1 559 206 3928</a></span>

                </dd>
                <dd className="flex">

                  <span className="ml-9">
                    <ReactCountryFlag className="mr-1" countryCode="ZA" svg
                      style={{
                        width: '1.5em',
                        height: '1.5em',
                      }} />
                    <a href="tel:+27 72 482 1895">+27 72 482 1895</a></span>
                </dd>
                <dd className="flex">

                  <span className="ml-9">
                    <ReactCountryFlag className="mr-1" countryCode="EU" svg
                      style={{
                        width: '1.5em',
                        height: '1.5em',
                      }} />
                    <a href="tel: +44 33 0058 0206"> +44 33 0058 0206</a></span>
              ...
              <div className="mt-3">
                ...
                <dd className="flex">
                  ...
                  <a className="ml-3" href="mailto:hi@flanksource.com">hi@flanksource.com</a>
                </dd>
              </div>
              ...
              <div className="mt-3">
                ...
                <dd className="flex">
                  <FaSlack className="flex-shrink-0 h-6 w-6 text-gray-400" aria-hidden="true" />

                  <a className="ml-3" href="https://join.slack.com/t/flanksource/shared_invite/zt-dvh61tg5-w8XOfrGWtCetGXYk48RKnw">flanksource.slack.com</a>
        ...
        <div className="bg-white py-16 px-4 sm:px-6 lg:col-span-3 lg:py-24 lg:px-8 xl:pl-12">
          <div className="max-w-lg mx-auto lg:max-w-none">
            <form className="grid grid-cols-1 gap-y-6" netlify>
              <div>
